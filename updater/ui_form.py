...
class Ui_updater(object):
    def setupUi(self, updater):
        ...
        self.c_.setGeometry(QRect(270, 10, 120, 30))
        self.c_sharp = QPushButton(updater)
        self.c_sharp.setObjectName(u"c_sharp")
        self.c_sharp.setGeometry(QRect(400, 10, 120, 30))
